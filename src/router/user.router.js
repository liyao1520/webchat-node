...
const { CheckParams, handlePassword, verifyPassword } = require("../middleware/user.middleware");
...
userRouter.patch("/password", verifyAuth, handlePassword, verifyPassword, updatePassword);
